...
cd /home/
#/bin/tar cf /var/www/html/webcp/backups/tmp/$RandomPath/${UserName}_web.tar public_html/ .passwd/
nice /bin/tar cf /var/www/html/webcp/backups/tmp/$RandomPath/${UserName}_web.tar ${UserName}/ --exclude=mail  
